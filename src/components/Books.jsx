    ...
    <div className=" books ">
      <div className="px-12 py-16 text-white flex flex-col md:flex-row justify-between">
        <div className="space-y-2">
            ...
            <div>
                <button className="btn mt-10 px-8 bg-white text-black rounded-xl py-0 book-font">SHOP NOW <FaArrowRight></FaArrowRight> </button>
            </div>
            <div className="">
        ...
        <div className="flex flex-col md:flex-row md:justify-end">
            <img className=" md:w-52 lg:w-64" src={book1} alt="" />
            <img className="relative left-5 md:left-0 md:w-1/2 lg:w-1/3" src={book2} alt="" />
        </div>
      </div>
    </div>
  );
