  ...
  return (
    <div className="quote flex flex-col md:flex-row items-center justify-center px-5 md:justify-between md:px-12 bg-gradient-to-r  from-red-600 to-red-700 text-white font-bold text-md md:text-2xl  ">
      <div className="order-2 md:order-1">
        ...
        <div data-aos="fade-in" data-aos-easing="ease-in-out" className="flex flex-col mx-5 tracking-wider relative -top-8 ">
      ...
      <div data-aos="fade-left" className="lg:w-1/4 md:w-1/3 relative -top-14 flex justify-center items-center md:right-8 order-1 md:order-2  ">
        <img src={pat} alt="" />
      </div>
    </div>
  );
